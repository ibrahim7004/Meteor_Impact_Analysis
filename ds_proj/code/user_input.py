...
df = pd.read_csv('C:/Users/hp/Desktop/ds_proj/excel_files/predicted_dataset1.csv')
...
df_new.to_csv('C:/Users/hp/Desktop/ds_proj/excel_files/output.csv', index=False)
