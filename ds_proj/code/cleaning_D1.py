...
def clean1():
    data = pd.read_csv("D:/ds_proj/excel_files/raw_D1.csv", encoding="cp1252")
    ...
    with open("D:/ds_proj/excel_files/dataset1.csv", mode="w", newline="") as file:
    ...
    # Saving as csv
    data.to_csv("D:/ds_proj/excel_files/dataset1.csv", index=False)
