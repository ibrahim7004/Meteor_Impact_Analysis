...
def train_model():
    df_train = pd.read_csv("D:/ds_proj/excel_files/dataset2.csv")
...
def predict_radiated_energy():
    df_test = pd.read_csv("D:/ds_proj/excel_files/predicted_dataset1.csv")
    ...
    df_test.to_csv("D:/ds_proj/excel_files/predicted_dataset1.csv")
