...
def func(country_name):
    ...
    [
        sg.Column(
            [
                ...
                [sg.Image(filename='D:\ds_proj\pics/plot1.1.png', size=(550, 260), key='-IMAGE-')],])]]
    ...
    [
        sg.Column(
            [
                ...
                [sg.Image(filename='D:\ds_proj\pics/plot2.1.png', size=(550, 260), key='-IMAGE-')],
    ...
    while True:
        ...
        if event == sg.WINDOW_CLOSED:
            ...
            window = sg.Window('Plotting', layout, size=(270,400), location=(850,350))
...
layout6 = [
    ...
    [sg.Button("Apply Random Forest."),sg.Button("What is RF?", button_color=('white', 'black'), font=('Helvetica', 8))],
    [sg.Button("Cancel.")]
]
...
window6 = sg.Window("Random Forest", layout6, size=(450, 100), element_justification='center', location=(400,300))
...
def mainFunc():
    ...
    for window in (window0, window1, window2, window3, window4, window5, window6, window8, window9, window10, window11):
        event, values = window.read()
        if event == sg.WIN_CLOSED or event == "Cancel.":
            for w in (window0, window1, window2, window3, window4, window5, window6, window8, window9, window10, window11):
                w.close()
            break
