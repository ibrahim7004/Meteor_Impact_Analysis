...
def order():
    df1 = pd.read_csv("D:/ds_proj/excel_files/dataset1.csv")
    df2 = pd.read_csv("D:/ds_proj/excel_files/dataset2.csv")
    ...
    df1["Radiated Energy"] = ""
    df1["Impact Energy"] = ""
    df1.to_csv("D:/ds_proj/excel_files/dataset1.csv", index=False)
